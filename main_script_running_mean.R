...
# prova (nuovi dati, ridotti con untitled1 script)
file_settaggio = 'C:/Users/giuli/Desktop/Draft_v5/fluxnet2015/BE-Vie_test_3a_2014.csv'      # MODIS, 'MAX' (2014)

# Settings files:
file_settaggio = 'C:/Users/giuli/Desktop/Settings_files/BE-Vie_test_3a_2014.csv'      # MODIS, 'MAX: noon approach'     (2014)
file_settaggio = 'C:/Users/giuli/Desktop/Settings_files/BE-Vie_test_3b_2014.csv'      # MODIS, 'MEAN: daily approach'   (2014)
file_settaggio = 'C:/Users/giuli/Desktop/Settings_files/BE-Vie_test_3H_2014.csv'      # MODIS, '3 hours approach'       (2014)


# 1) Max vs Daily approaches: for all sites
# BE-Vie
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/BE-Vie_test_3a_2014.csv'      # MODIS, 'MAX'   (2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/BE-Vie_test_3b_2014.csv'      # MODIS, 'MEAN'   (2014)
# USA
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/US-UMB_test_3a.csv'           # MODIS, 'MAX'  (2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/US-UMB_test_3b.csv'           # MODIS, 'MEAN'
# Hyy
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/FI-Hyy_test_3d_2014.csv'      # MODIS, 'MAX'     (2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/FI-Hyy_test_3e_2014.csv'      # MODIS, 'MEAN'     (2014)
# CH-Cha
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/CH_Cha_test_3a.csv'           # MODIS, 'MAX'    (2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/CH_Cha_test_3b.csv'           # MODIS, 'MEAN'    (2014)
# GF-Guy
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/GF_Guy_test_3a.csv'           # MODIS, 'MAX'    (2009-2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/GF_Guy_test_3b.csv'           # MODIS, 'MEAN'    (2009-2014)

# 2) 3-HOUR approach (run the right 'example command' below)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/BE-Vie_test_3H_2014.csv'      # MODIS, '3H'   (2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/FI-Hyy_test_3H_2014.csv'      # MODIS, '3H'   (2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/GF_Guy_test_3H.csv'           # MODIS, '3H'   (2009-2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/US-UMB_test_3H.csv'           # MODIS, '3H'  (2014)
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/CH_Cha_test_3H.csv'           # MODIS, '3H'  (2014)

# 4) 'xi_acclimated' ON e OFF: for all sites
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/BE-Vie_test_3c_2014.csv'      # MODIS, 'off'   (2014)

...
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper/FI-Hyy_settaggi_test_3a.csv'      # MODIS, 2014 
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper_v1/GF_Guy_settaggi_test_3b.csv'   # MODIS, 2014
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/CH_Cha_settaggi_test_3c.csv'                  # MODIS, 2014
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper_v1/CH_Cha_settaggi_test_3c.csv'   # MODIS, 2014 
# file_settaggio = 'C:/pModelPlus/pModelPlus/data/First_paper_v1/US-UMB_settaggi_test_3c.csv'   # MODIS, 2014
